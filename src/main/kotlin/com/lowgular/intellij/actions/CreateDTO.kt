...
fun makeCommand(pluginDir: String): GeneralCommandLine {
    val cliFile = JSLanguageServiceUtil.getPluginDirectory(CreateDTO::class.java, "cli/api-client.cli.js")
    LOG.warn(cliFile.absolutePath);
    val moduleExe = "node"
    val commandLine = GeneralCommandLine(
        moduleExe, cliFile.toString(), "{\n" +
